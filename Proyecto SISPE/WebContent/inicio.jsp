                        ...
                        <article class="grid_8">
                            ...
                            <div class="wrapper p4">
                            	<article class="grid_4 alpha">
                                    ...
                                    <p class="prev-indent-bot">This <a class="color-2" href="http://blog.templatemonster.com/2011/12/10/free-website-template-jquery-slider-consulting-business/" target="_blank" rel="nofollow">Consulting Template</a> goes with two<br> packages â€“ with PSD source files and<br> without them.</p>
                            ...
                            <div class="wrapper">
                                ...
                                <article class="grid_4 omega">
                                    ...
                                    <p class="prev-indent-bot">This template has several pages: <a class="color-2" href="inicio.html">Home</a>,<br>  <a class="color-2" href="company.html">Company</a>, <a class="color-2" href="services.html">Services</a>, <a class="color-2" href="projects.html">Projects</a>, <a class="color-2" href="contact.html">Contacts</a> (note<br> that contact us form â€“ doesnâ€™t work).</p>
                                    <a class="link-1" href="#">Know More</a>
                                </article>
                            </div>
                        </article>
